...
import com.marc.libraray.ImageTextView.callback.ImageGetter;
...
import com.marc.libraray.ImageTextView.ig.DefaultImageGetter;
...
public final class RichTextConfig {
    ...
    public static final class RichTextConfigBuild {
         ...
         * @return RichTextConfigBuild
         */
        public ImageTextView into(TextView textView) {
            ...
            ImageTextView richText = new ImageTextView(new RichTextConfig(this), textView);
            if (tag != null) {
                ImageTextView.bind(tag.get(), richText);
            }
            this.tag = null;
